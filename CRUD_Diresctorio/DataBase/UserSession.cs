...
namespace Shared.Session
{
    public static class UserSession
    {
        ...
        private static bool _esAdminSistema;
        ...
        {
            get => _esAdminSistema;
            private set => _esAdminSistema = value;
        }

        public static void IniciarSesionAdmin(int idUsuario, string username, string nombreCompleto, string rol)
        {
            IdUsuario = idUsuario;
            Username = username;
